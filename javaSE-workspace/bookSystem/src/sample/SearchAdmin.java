...
public class SearchAdmin implements Initializable{

    public TableView<bookAdmin> tableview_show;
    ...
    public TableColumn table_lentTo;
    ...
    public void click_tableview(){
        bookAdmin select_book= tableview_show.getSelectionModel().getSelectedItem();
        ...
        String select_lentTo=select_book.getTable_lentTo();
        ...
        label_lentTo.setText(select_lentTo);
    ...
    public int choice_kind()
    {
        ...
        else if (str_kind.equals("按出版社搜索"))
        {
            return 5;
        }
        else
    ...
    public void search_user(){
        ...
        ArrayList<bookAdmin> right_book=new ArrayList<>();
        for(int i=0;i<book_list.size();i++) {
            String book_user = ((book_list.get(i)).split(","))[6];
            if(book_user.equals(input_text))
            {
                right_book.add(new bookAdmin(book_list.get(i)));
            }
        }
    ...
    private void dataBind(ObservableList<bookAdmin> list)
    {
        ...
        table_lentTo.setCellValueFactory(new PropertyValueFactory("table_lentTo"));
